use rust_harp::app_state;
use rust_harp::chord::Chord;
use rust_harp::notes::{MidiNote, NoteVolume, Transpose, UnkeyedNote, UnmidiNote};
use rust_harp::output_midi::MidiVelocityPair;
use rust_harp::ui_adapter::AppAdapter;
